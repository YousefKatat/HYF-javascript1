...
arr_1.push(2); // write this line
arr_2.push(2); // write this line
console.assert(arr_1[arr_2[2]] === arr_2[arr_1[2]]);

let arr_3 = [2]; // write this line
...
let obj_2 = [key++], obj_3 = [1]; // write this line
...
obj_1.x = (key); // write this line
obj_2.x = (key); // write this line
console.assert(obj_1[obj_2.y] === obj_2[obj_1.y]);

let obj_3 = {}; // write this line
...
obj_3.key = obj_2.x; // write this line
